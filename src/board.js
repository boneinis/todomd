...
export function createCard(repoPath, fields) {
  return withRepoLock(repoPath, async () => {
    ...
    const isEpic = Boolean(fields.epic || fields.type === 'epic');
    const content = `---
id: ${id}
