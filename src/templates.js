...
# Shared cross-project admission for Plan, Triage, Build, CI, Verify and card
# conversations, also bounded by this board's concurrency and resource governor.
# The strictest registered project's cap wins. Plan/Triage default to 1;
# set a positive integer to raise either cap. Other columns and global use
# 0 for unlimited. Running jobs finish; new admissions wait under pressure.
scheduler:
...
\`\`\`
npx todomd budget-write . -- /bin/sh /absolute/path/to/transaction.sh
\`\`\`
